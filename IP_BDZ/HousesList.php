            ...
            for($j=0; $j<count($data['data_']['body']['level']['Subject'][$i]['level']['Rayons']); $j++)
                if($j==$t)
                    for($k=0; $k<count($data['data_']['body']['level']['Subject'][$i]['level']['Rayons'][$j]['level']['Cities']); $k++)
                        if($k==$_POST["id3"])
                            for($p=0; $p<count($data['data_']['body']['level']['Subject'][$i]['level']['Rayons'][$j]['level']['Cities'][$k]['level']['Houses']); $p++)
                            {
                                $array3[$count] = $data['data_']['body']['level']['Subject'][$i]['level']['Rayons'][$j]['level']['Cities'][$k]['level']['Houses'][$p]['adr'];
                                $count++;
                            }
